...
Try the [interactive voice orb animation example](/examples/voice-orb-ui) to compare themes,
motion presets, and both audio directions before connecting a provider.
